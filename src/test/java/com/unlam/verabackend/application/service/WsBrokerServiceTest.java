...
//
//    @InjectMocks
//    private WsBrokerService wsBrokerService;
//
...
//
//        wsBrokerService.createAndSendNotification(sampleUser, type, triggeringUser, payload);
//
...
//        when(repository.findUnreadByUserEmail(userEmail)).thenReturn(Collections.emptyList());
//
//        wsBrokerService.createAndSendNotification(sampleUser, NotificationsType.ALERT, "Test User", Collections.emptyMap());
//
...
//
//        assertDoesNotThrow(() -> wsBrokerService.sendDeleteEvent(userEmail, mockId));
